...
class Asesorias extends Controlador{
    ...
    public function filtro($pagina = 0){
        if ($_SERVER['REQUEST_METHOD'] == 'GET') {
            ...
            $this->datos["asesorias"] = $this->asesoriaModelo->getAsesoriasFiltro($datos,$pagina,TAM_PAGINA);
            foreach($this->datos["asesorias"]->registros as $asesoria){
                $asesoria->acciones = $this->asesoriaModelo->getAccionesAsesoria($asesoria->id_asesoria);
            }
