...
<div class="container">
    ...
    <strong class="text-success">Nº de Registros: <?php echo $datos["asesorias"]->numTotalRegistros ?></strong>
    <script>
    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            <?php foreach ( $datos["asesorias"]->registros as $asesoria ): ?>
                <tr id="asesoria_<?php echo $asesoria->id_asesoria ?>">
                    ...
                    <td><?php 
                        echo ($asesoria->nombre_as) ? $asesoria->nombre_as: "";
    ...
    <?php endif ?>
                    ...
                    <td style="width: 50px;">
                        <button class="accordion-button collapsed custom-button" type="button" data-bs-toggle="collapse" data-bs-target="#acciones_<?php echo $asesoria->id_asesoria ?>" aria-expanded="false"></button>
                    </td>


                </tr>
                <tr></tr>
                <tr id="acciones_<?php echo $asesoria->id_asesoria ?>" class="accordion-collapse collapse">
                    <td></td>
                    <td colspan="6">
                        <?php 
                            echo ($asesoria->dni_as) ? '<strong>DNI: </strong>'.$asesoria->dni_as : '<strong>DNI: </strong> - ';
                            echo ($asesoria->telefono_as) ? '<strong class="ms-3">teléfono: </strong>'.$asesoria->telefono_as : '<strong class="ms-3">teléfono: </strong> - ';
                            echo ($asesoria->email_as) ? '<strong class="ms-3">email: </strong>'.$asesoria->email_as : '<strong class="ms-3">email: </strong> - ';
                       
                            echo ($asesoria->domicilio_as) ? '<br><strong>Domicilio: </strong>'.$asesoria->domicilio_as : '<br><strong>Domicilio: </strong> - ';
                        
                            echo ($asesoria->domicilio_as) ? '<br><strong>Descripción: </strong><p class="ms-3">'.$asesoria->descripcion_as.'</p>' : '';
                        ?>
                    </td>
                </tr>
                <tr></tr>
    ...
    <script>
        paginar(<?php echo $datos['asesorias']->paginaActual ?>,<?php echo $datos['asesorias']->numPaginas ?>,'<?php echo RUTA_URL?>/asesorias/filtro','<?php echo $datos['cadenaGet'] ?>')
    </script>
